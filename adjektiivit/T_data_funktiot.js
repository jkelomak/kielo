    ...
    T_data_logadjektiivi = function() {
        console.log(T_data_virheNumero("adjektiivi") + " virhenumero");
        console.log(T_data_oikMaara("adjektiivi") + " oikein adjektiiveja");
        console.log(T_data.virheNimet);
        console.log(T_data.oikVektori);
    }
